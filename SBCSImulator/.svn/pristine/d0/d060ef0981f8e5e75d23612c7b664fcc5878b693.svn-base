...
CREATE TABLE endpoints (
  ...
  UNIQUE KEY GroupId_Ep_Port (GroupId,Realm,Endpoint,Port),
...
CREATE TABLE msws (
  ...
  LastModified datetime NOT NULL default '0000-00-00 00:00:00',
  PRIMARY KEY  (MSWId),
  UNIQUE KEY MSWName (MSWName, MSWIp)
) TYPE=MyISAM PACK_KEYS=DEFAULT;
...
REPLACE INTO groups VALUES (-1,'',now(),now());
REPLACE INTO groups VALUES (-2,'*',now(),now());
...
REPLACE INTO periods VALUES (1,'-1','DefaultPlan',NULL,NULL, NULL,127,127,'00:00:00','23:59:59',now(),now());
