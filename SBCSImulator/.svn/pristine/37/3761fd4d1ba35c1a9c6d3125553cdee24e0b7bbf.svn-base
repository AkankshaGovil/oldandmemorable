...
# $Id: tme = $ARGV[0];$filename = $ARGV[0];rap.pl,v 4.1 2002/05/06 12:30:37 dtown Rel $
...
if (!defined($result)) {
   ...
   printf("Trap with default values\n")
}
...
if (!defined($result)) {
   ...
   printf("Trap 3 \n");
   printf("Trap-PDU sent.\n");
   printf("Trap -- Link Down");
}


## A second trap example using mainly default val
