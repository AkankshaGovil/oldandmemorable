...
ProgDescription="GENBAND Development Setup Utility"
...
## $ARGS is set to $* before calling this function
##
ProcessOptions () {
while getopts eFhm:no:r:vV i $ARGS
do
	case $i in
	e)
		LOGNAME=$OPTARG
