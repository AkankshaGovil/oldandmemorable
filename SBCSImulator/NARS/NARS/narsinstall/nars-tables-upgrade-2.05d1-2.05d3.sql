#####################################################
## Use this when upgrading from NARS 2.05d1 to 2.05d3
#####################################################
...
##
alter table nars.ratedcdr change BuyRoundedSec BuyRoundedSec INTEGER NOT NULL default 0;
alter table nars.ratedcdr change SellRoundedSec SellRoundedSec INTEGER NOT NULL default 0;
select "" as "Altered ratedcdr table data";
