...
/opt/nxtn/jdk/bin/java -Djavax.net.ssl.trustStore="/opt/nxtn/jboss/server/default/conf/client.truststore" -Djavax.net.ssl.trustStorePassword="shipped!!" -classpath "$classpath" ImportRoutes "$@"
